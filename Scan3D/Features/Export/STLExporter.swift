...
actor STLExporter {
    ...
    func ecrire(_ maillage: Mesh, nom: String) throws -> URL {
        ...
        let donnees = try STLWriter.binaryData(for: maillage)
        ...
        Logger.export.info("STL écrit : \(maillage.triangleCount, privacy: .public) triangles, \(donnees.count, privacy: .public) octets")
        return fichier
    }
